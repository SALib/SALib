...
salib analyze hdmr ^
  -p ../../../src/SALib/test_functions/params/case3.txt ^
  -X ../../data/case3_input.txt ^
  -Y ../../data/case3_output.txt ^
  -c 0 ^
  -g 1 ^
  -mor 2 ^
  -mit 100 ^
...
REM      -p ../../../src/SALib/test_functions/params/case3.txt ^
REM      -X ../../data/case3_input.txt ^
REM      -Y ../../data/case3_output.txt ^
REM      -c 0 ^
REM      -g 1 ^
REM      -mor 2 ^
REM      -mit 100 ^
