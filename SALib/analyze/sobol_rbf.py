...
if __name__ == "__main__":
    ...
    parser.add_argument('-N', '--N-rbf', type=int, required=False,
                        default=10000, help='Number of sample points on the RBF surface')
    parser.add_argument('-k', '--n-folds', type=int, required=False,
                        default=10, help='Number of folds in SVR cross-validation')
    parser.add_argument('-t', '--training-sample', type=int, required=False, default=None,
